...
template<class T> vec2<T> operator*(const vec2<T> &, const mat4<T> &);	//vec3
template<class T> vec2<T> operator*(const mat4<T> &, const vec2<T> &);	//vec3
...
//------------------------------------------------------------------------------
template<class T>
vec2<T> operator*(const vec2<T> &v, const mat4<T> &mat)
{
	return vec3<T>(mat.m00*v.x + mat.m10*v.y + mat.m20 + mat.m30,
				   mat.m01*v.x + mat.m11*v.y + mat.m21 + mat.m31,
				   mat.m02*v.x + mat.m12*v.y + mat.m22 + mat.m32);
}
//------------------------------------------------------------------------------
template<class T>
vec2<T> operator*(const mat4<T> &mat, const vec2<T> &t)
{
	return vec3<T>(mat.m00*t.x + mat.m10*t.y + mat.m20 + mat.m30,
				   mat.m01*t.x + mat.m11*t.y + mat.m21 + mat.m31,
				   mat.m02*t.x + mat.m12*t.y + mat.m22 + mat.m32);
}
//------------------------------------------------------------------------------
template<class T>
